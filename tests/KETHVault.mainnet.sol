...
contract KETHVaultMainnetTest is TestUtils {
    ...
    function testIntegrationKETH1() public {
        ...
        vm.startPrank(strategyManager);
        kETHStrategy.invokeSwap(wstETHToDETH, wstETH, 2 ether, dETH, 0);
        vm.stopPrank();
        vm.startPrank(strategyManager);
        kETHStrategy.invokeSwap(rETHToDETH, rETH, 2 ether, dETH, 0);
        vm.stopPrank();
    ...
    function testIntegrationKETH3() public {
        ...
        vm.startPrank(strategyManager);
        kETHStrategy.invokeSwap(rETHToDETH, wstETH, 2 ether, dETH, 0);
        vm.stopPrank();
